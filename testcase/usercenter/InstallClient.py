...
class InstallClicent(CommonLogin):
    def setUp(self):
    ...
    def test_install_client(self):
        sel = self.selenium
        #=======================================================================
        # A login user click "InstallClient" menu on the left bar of user_center page
        #=======================================================================
        sel.click('xpath=//div[@class="top_menu"]/a[2]')
        sel.wait_for_page_to_load(5000)
        sel.click('xpath=//div[@class="part_div1_1 main_color2"]/div[3]/a[2]')
        sel.wait_for_page_to_load(5000)
